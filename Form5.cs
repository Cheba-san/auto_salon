...
namespace auto_salon
{
    public partial class Form5 : Form
    {
        ...
        public void getInfo()
        {
            string query = ("SELECT sales.id_sale as '№', auto.name as 'Название авто', clients.fio as 'ФИО Клиента' from sales JOIN auto on sales.id_auto = auto.id_auto join clients on sales.id_client = clients.id_client");
